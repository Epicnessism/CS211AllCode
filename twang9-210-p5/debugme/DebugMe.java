...
public class DebugMe {
  ...
  public static void main(String[] args){ //twang9 2 30 17 0 8 30 0 0 0 0 0000000000000 0 6 12 2 6 0 8 0 "a closed mouth gathers no feet" 0 2 3 10 1 1 4 1
    int argsNeeded = 29;
  ...
  // 3 args
  public static void phase2(int hash, String[] args, int argStart){ //0 8 30
    int a = Integer.parseInt(args[argStart+0]);
    int b = Integer.parseInt(args[argStart+1]);
    int c = Integer.parseInt(args[argStart+2]);
    ...
    v /= b; //unknown/8 = 
    v += 14; //16+14 = 30
    if (c!=v){ failure("these are not the ints you're searching for..."); } //c=30=v
  }
  
  // 4 args
  public static void phase3(int hash, String[] args, int argStart){ //0 0 0 0
    int a = Integer.parseInt(args[argStart+0]);
    int b = Integer.parseInt(args[argStart+1]);
    int c = Integer.parseInt(args[argStart+2]);
    int d = Integer.parseInt(args[argStart+3]);
    
    if (hash%13 > 4) { //hash=8094
      c += hash%13; //c=8
    }
    else {
      a *= hash%5 + 1;
  ...
  // 4 args
  public static void phase4(int hash, String[] args, int argStart){ //0 0 0 0
  ...
  // 2 args
  public static void phase5(int hash, String[] args, int argStart){ //2 6
    int a = Integer.parseInt(args[argStart+0]);
    int b = Integer.parseInt(args[argStart+1]);
  ...
  // 3 args
  public static void phase7(int hash, String[] args, int argStart){ //0 2 4
    int a = Integer.parseInt(args[argStart+0]);
    int b = Integer.parseInt(args[argStart+1]);
    int c = Integer.parseInt(args[argStart+2]);
    int d = sumRange(a,b);
  ...
  // 3 args
  public static void phase8(int hash, String[] args, int argStart) { //10 1 1 
  ...
  // 2 args
  public static void phase9(int hash, String[] args, int argStart){ // 0 2
