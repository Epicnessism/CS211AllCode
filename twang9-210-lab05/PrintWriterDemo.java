...
public class PrintWriterDemo {
    ...
    throws FileNotFoundException // WTF?
  {
    ...
    PrintWriter ot = new PrintWriter(System.out);   // Write to the screen instead
    ot.println("Sweet foutput");
    ot.printf("An int: %d\nA double %.1f\nA string: %s\n",
        1, 2.5, "Three");
    ot.close();                // May close System.out (bad)
    //PrintWriter ot = new(PrintWriter(
